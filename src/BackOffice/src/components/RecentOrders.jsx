				...
				<table className="w-full text-gray-700">
					...
					<tbody>
						{currentOrders.map((champ) => (
							<tr key={champ._id} onClick={() => handleRowClick(champ._id)} className="hover:bg-gray-100 select-none">
								...
								<td className="border border-gray-400 py-2 text-center">{getOrderStatus("CONFIRMED")}</td>
							</tr>
						))}
					</tbody>
				</table>
